...
class cv2_createAffineTransformer_0:
	@classmethod
	def INPUT_TYPES(cls):
		return {
			'required': {
	...
	def execute(self, fullAffine):
		ret = apply_function(cv2.createAffineTransformer, [fullAffine], [], [])
		return ret

NODE_DISPLAY_NAME_MAPPINGS	["createAffineTransformer_0"] = "OpenCV createAffineTransformer_0"
NODE_CLASS_MAPPINGS	["createAffineTransformer_0"] = cv2_createAffineTransformer_0

class cv2_createAlignMTB_0:
	@classmethod
	def INPUT_TYPES(cls):
		return {
			'required': {
	...
	def execute(self, max_bits, exclude_range, cut):
		ret = apply_function(cv2.createAlignMTB, [max_bits, exclude_range, cut], [], [])
		return ret

NODE_DISPLAY_NAME_MAPPINGS	["createAlignMTB_0"] = "OpenCV createAlignMTB_0"
NODE_CLASS_MAPPINGS	["createAlignMTB_0"] = cv2_createAlignMTB_0

class cv2_createBackgroundSubtractorKNN_0:
	@classmethod
	def INPUT_TYPES(cls):
		return {
			'required': {
	...
	def execute(self, history, dist2Threshold, detectShadows):
		ret = apply_function(cv2.createBackgroundSubtractorKNN, [history, dist2Threshold, detectShadows], [], [])
		return ret

NODE_DISPLAY_NAME_MAPPINGS	["createBackgroundSubtractorKNN_0"] = "OpenCV createBackgroundSubtractorKNN_0"
NODE_CLASS_MAPPINGS	["createBackgroundSubtractorKNN_0"] = cv2_createBackgroundSubtractorKNN_0

class cv2_createBackgroundSubtractorMOG2_0:
	@classmethod
	def INPUT_TYPES(cls):
		return {
			'required': {
	...
	def execute(self, history, varThreshold, detectShadows):
		ret = apply_function(cv2.createBackgroundSubtractorMOG2, [history, varThreshold, detectShadows], [], [])
		return ret

NODE_DISPLAY_NAME_MAPPINGS	["createBackgroundSubtractorMOG2_0"] = "OpenCV createBackgroundSubtractorMOG2_0"
NODE_CLASS_MAPPINGS	["createBackgroundSubtractorMOG2_0"] = cv2_createBackgroundSubtractorMOG2_0

class cv2_createCLAHE_0:
	@classmethod
	def INPUT_TYPES(cls):
		return {
			'required': {
	...
	def execute(self, clipLimit, tileGridSize):
		ret = apply_function(cv2.createCLAHE, [clipLimit, tileGridSize], [], [1])
		return ret

NODE_DISPLAY_NAME_MAPPINGS	["createCLAHE_0"] = "OpenCV createCLAHE_0"
NODE_CLASS_MAPPINGS	["createCLAHE_0"] = cv2_createCLAHE_0

class cv2_createCalibrateDebevec_0:
	@classmethod
	def INPUT_TYPES(cls):
		return {
			'required': {
	...
	def execute(self, samples, lambda_, random):
		ret = apply_function(cv2.createCalibrateDebevec, [samples, lambda_, random], [], [])
		return ret

NODE_DISPLAY_NAME_MAPPINGS	["createCalibrateDebevec_0"] = "OpenCV createCalibrateDebevec_0"
NODE_CLASS_MAPPINGS	["createCalibrateDebevec_0"] = cv2_createCalibrateDebevec_0

class cv2_createCalibrateRobertson_0:
	@classmethod
	def INPUT_TYPES(cls):
		return {
			'required': {
	...
	def execute(self, max_iter, threshold):
		ret = apply_function(cv2.createCalibrateRobertson, [max_iter, threshold], [], [])
		return ret

NODE_DISPLAY_NAME_MAPPINGS	["createCalibrateRobertson_0"] = "OpenCV createCalibrateRobertson_0"
NODE_CLASS_MAPPINGS	["createCalibrateRobertson_0"] = cv2_createCalibrateRobertson_0

class cv2_createGeneralizedHoughBallard_0:
	@classmethod
	def INPUT_TYPES(cls):
		return {
			'required': {
	...
	def execute(self, ):
		ret = apply_function(cv2.createGeneralizedHoughBallard, [], [], [])
		return ret

NODE_DISPLAY_NAME_MAPPINGS	["createGeneralizedHoughBallard_0"] = "OpenCV createGeneralizedHoughBallard_0"
NODE_CLASS_MAPPINGS	["createGeneralizedHoughBallard_0"] = cv2_createGeneralizedHoughBallard_0

class cv2_createGeneralizedHoughGuil_0:
	@classmethod
	def INPUT_TYPES(cls):
		return {
			'required': {
	...
	def execute(self, ):
		ret = apply_function(cv2.createGeneralizedHoughGuil, [], [], [])
		return ret

NODE_DISPLAY_NAME_MAPPINGS	["createGeneralizedHoughGuil_0"] = "OpenCV createGeneralizedHoughGuil_0"
NODE_CLASS_MAPPINGS	["createGeneralizedHoughGuil_0"] = cv2_createGeneralizedHoughGuil_0
...
class cv2_createHausdorffDistanceExtractor_0:
	@classmethod
	def INPUT_TYPES(cls):
		return {
			'required': {
	...
	def execute(self, distanceFlag, rankProp):
		ret = apply_function(cv2.createHausdorffDistanceExtractor, [distanceFlag, rankProp], [], [])
		return ret

NODE_DISPLAY_NAME_MAPPINGS	["createHausdorffDistanceExtractor_0"] = "OpenCV createHausdorffDistanceExtractor_0"
NODE_CLASS_MAPPINGS	["createHausdorffDistanceExtractor_0"] = cv2_createHausdorffDistanceExtractor_0

class cv2_createLineSegmentDetector_0:
	@classmethod
	def INPUT_TYPES(cls):
		return {
			'required': {
	...
	def execute(self, refine, scale, sigma_scale, quant, ang_th, log_eps, density_th, n_bins):
		ret = apply_function(cv2.createLineSegmentDetector, [refine, scale, sigma_scale, quant, ang_th, log_eps, density_th, n_bins], [], [])
		return ret

NODE_DISPLAY_NAME_MAPPINGS	["createLineSegmentDetector_0"] = "OpenCV createLineSegmentDetector_0"
NODE_CLASS_MAPPINGS	["createLineSegmentDetector_0"] = cv2_createLineSegmentDetector_0

class cv2_createMergeDebevec_0:
	@classmethod
	def INPUT_TYPES(cls):
		return {
			'required': {
	...
	def execute(self, ):
		ret = apply_function(cv2.createMergeDebevec, [], [], [])
		return ret

NODE_DISPLAY_NAME_MAPPINGS	["createMergeDebevec_0"] = "OpenCV createMergeDebevec_0"
NODE_CLASS_MAPPINGS	["createMergeDebevec_0"] = cv2_createMergeDebevec_0

class cv2_createMergeMertens_0:
	@classmethod
	def INPUT_TYPES(cls):
		return {
			'required': {
	...
	def execute(self, contrast_weight, saturation_weight, exposure_weight):
		ret = apply_function(cv2.createMergeMertens, [contrast_weight, saturation_weight, exposure_weight], [], [])
		return ret

NODE_DISPLAY_NAME_MAPPINGS	["createMergeMertens_0"] = "OpenCV createMergeMertens_0"
NODE_CLASS_MAPPINGS	["createMergeMertens_0"] = cv2_createMergeMertens_0

class cv2_createMergeRobertson_0:
	@classmethod
	def INPUT_TYPES(cls):
		return {
			'required': {
	...
	def execute(self, ):
		ret = apply_function(cv2.createMergeRobertson, [], [], [])
		return ret

NODE_DISPLAY_NAME_MAPPINGS	["createMergeRobertson_0"] = "OpenCV createMergeRobertson_0"
NODE_CLASS_MAPPINGS	["createMergeRobertson_0"] = cv2_createMergeRobertson_0

class cv2_createTonemap_0:
	@classmethod
	def INPUT_TYPES(cls):
		return {
			'required': {
	...
	def execute(self, gamma):
		ret = apply_function(cv2.createTonemap, [gamma], [], [])
		return ret

NODE_DISPLAY_NAME_MAPPINGS	["createTonemap_0"] = "OpenCV createTonemap_0"
NODE_CLASS_MAPPINGS	["createTonemap_0"] = cv2_createTonemap_0

class cv2_createTonemapDrago_0:
	@classmethod
	def INPUT_TYPES(cls):
		return {
			'required': {
	...
	def execute(self, gamma, saturation, bias):
		ret = apply_function(cv2.createTonemapDrago, [gamma, saturation, bias], [], [])
		return ret

NODE_DISPLAY_NAME_MAPPINGS	["createTonemapDrago_0"] = "OpenCV createTonemapDrago_0"
NODE_CLASS_MAPPINGS	["createTonemapDrago_0"] = cv2_createTonemapDrago_0

class cv2_createTonemapMantiuk_0:
	@classmethod
	def INPUT_TYPES(cls):
		return {
			'required': {
	...
	def execute(self, gamma, scale, saturation):
		ret = apply_function(cv2.createTonemapMantiuk, [gamma, scale, saturation], [], [])
		return ret

NODE_DISPLAY_NAME_MAPPINGS	["createTonemapMantiuk_0"] = "OpenCV createTonemapMantiuk_0"
NODE_CLASS_MAPPINGS	["createTonemapMantiuk_0"] = cv2_createTonemapMantiuk_0

class cv2_createTonemapReinhard_0:
	@classmethod
	def INPUT_TYPES(cls):
		return {
			'required': {
	...
	def execute(self, gamma, intensity, light_adapt, color_adapt):
		ret = apply_function(cv2.createTonemapReinhard, [gamma, intensity, light_adapt, color_adapt], [], [])
		return ret

NODE_DISPLAY_NAME_MAPPINGS	["createTonemapReinhard_0"] = "OpenCV createTonemapReinhard_0"
NODE_CLASS_MAPPINGS	["createTonemapReinhard_0"] = cv2_createTonemapReinhard_0
...
class cv2_empty_array_desc_0:
	...
	def execute(self, ):
		ret = apply_function(cv2.empty_array_desc, [], [], [])
		return ret

NODE_DISPLAY_NAME_MAPPINGS	["empty_array_desc_0"] = "OpenCV empty_array_desc_0"
NODE_CLASS_MAPPINGS	["empty_array_desc_0"] = cv2_empty_array_desc_0

class cv2_empty_gopaque_desc_0:
	@classmethod
	def INPUT_TYPES(cls):
		return {
			'required': {
	...
	def execute(self, ):
		ret = apply_function(cv2.empty_gopaque_desc, [], [], [])
		return ret

NODE_DISPLAY_NAME_MAPPINGS	["empty_gopaque_desc_0"] = "OpenCV empty_gopaque_desc_0"
NODE_CLASS_MAPPINGS	["empty_gopaque_desc_0"] = cv2_empty_gopaque_desc_0

class cv2_empty_scalar_desc_0:
	@classmethod
	def INPUT_TYPES(cls):
		return {
			'required': {
	...
	def execute(self, ):
		ret = apply_function(cv2.empty_scalar_desc, [], [], [])
		return ret

NODE_DISPLAY_NAME_MAPPINGS	["empty_scalar_desc_0"] = "OpenCV empty_scalar_desc_0"
NODE_CLASS_MAPPINGS	["empty_scalar_desc_0"] = cv2_empty_scalar_desc_0
